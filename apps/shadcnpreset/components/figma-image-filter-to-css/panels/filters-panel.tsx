    ...
    <Card>
      ...
      <CardContent>
        <FieldSet>
          <FieldGroup>
            <Field>
              <FieldLabel htmlFor="preview-image-url">Preview image URL</FieldLabel>
              <FieldDescription>
                ...
                {FILTER_FIELDS.map((field) => {
                  ...
                  return (
                    <Field key={field.key}>
                      ...
                      <FieldDescription>{formatFigmaValue(value)}</FieldDescription>
                      <input
                        ...
                        value={value}
                        onChange={(event) =>
                          model.updateFilter(field.key, Number.parseFloat(event.target.value))
                        }
                          ...
                          <Tabs defaultValue="custom">
                            ...
                            <TabsContent value="custom">
                              <div className="grid gap-2">
                                ...
                                <Input value={model.overlayOklchColor} readOnly />
                                <p className="text-xs text-muted-foreground">
                                  Custom color uses arbitrary Tailwind class output.
                                </p>
                              </div>
                            </TabsContent>
                            <TabsContent value="tailwind-v4">
                              <div className="grid gap-2">
                                <Input
                                  ...
                                  onChange={(event) =>
                                    model.setTailwindColorSearch(event.target.value)
                                  }
                                />
                                <div className="max-h-[280px] overflow-y-auto rounded-md border border-border/60 p-2">
                                  <div className="grid grid-cols-3 gap-2 sm:grid-cols-4">
                                    {model.filteredTailwindPalette.map((swatch) => {
                                      const isActive =
                                        model.overlayTailwindClassName === swatch.className
